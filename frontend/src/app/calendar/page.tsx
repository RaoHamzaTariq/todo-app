...
export default function CalendarPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Calendar is Under Construction</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-lg mb-8">We're working hard to bring you the best experience. The Calendar feature will be available soon!</p>
            <Link href="/dashboard">
